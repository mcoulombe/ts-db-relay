...
// Replace directives to fix OpenBao v2.4.0's go.mod which references v2.0.0 of auth
// modules that don't exist (earliest version is v2.0.1). Map them to v2.4.0 to match
// our OpenBao version.
replace (
	github.com/openbao/openbao/api/auth/approle/v2 v2.0.0 => github.com/openbao/openbao/api/auth/approle/v2 v2.4.0
