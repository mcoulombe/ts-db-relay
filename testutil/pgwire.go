...
// MustOpenPGWire opens a database connection and performs a ping test.
func MustOpenPGWire(t *testing.T, clientTsnet *tsnet.Server, connectorIP netip.Addr, pgPort int, pgDB string, pgRole string) *sql.DB {
	t.Helper()
